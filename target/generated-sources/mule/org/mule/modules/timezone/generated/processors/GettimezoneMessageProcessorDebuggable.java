...
public class GettimezoneMessageProcessorDebuggable
    extends GettimezoneMessageProcessor
    implements DebugInfoProvider
{


    public GettimezoneMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("latitude", "Latitude", (java.lang.String.class), latitude, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("longitude", "Longitude", (java.lang.String.class), longitude, muleEvent));
